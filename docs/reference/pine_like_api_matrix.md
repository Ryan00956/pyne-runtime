...
| Strategy reporting | `strategy.equity`, `strategy.netprofit`, `strategy.openprofit`, `strategy.grossprofit`, `strategy.grossloss`; output `summary`, `closedtrades`, `opentrades` | Partial | Trade ledgers are net-position based rather than full Pine entry-id ledgers | `tests/test_strategy_runtime.py` | `docs/api/strategy.md` |
