...
| Bar clock | `bar_index`, `last_bar_index`, `time` | Supported | Batch runtime exposes full-series values | `tests/test_barstate.py` | `docs/concepts/bar_execution_model.md` |
| Bar flags | `barstate.isfirst`, `barstate.islast`, `barstate.isconfirmed` | Supported | Realtime preview semantics are still limited | `tests/test_barstate.py` | `docs/concepts/bar_execution_model.md` |
